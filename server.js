...
const { adminRouter: propostasAdminRouter, publicRouter: propostasPublicRouter } = require('./routes/propostas');
...
app.use('/api/public', propostasPublicRouter);
app.use('/api/public', trackedLinksPublicRouter);
