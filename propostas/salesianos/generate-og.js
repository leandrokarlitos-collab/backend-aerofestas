/**
 * Gera capa Open Graph 1200x630 premium para a proposta Salesianos.
 * Output: /propostas/salesianos/img/og-cover.jpg
 */
...
const featured = [
  ...
  'combo-3-em-1-dino-800.webp',
  'area-restrita-t-rex-800.webp',
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
  ...
  <text x="60" y="320" font-family="Outfit, Arial, sans-serif" font-size="90" font-weight="900" fill="url(#redShimmer)" letter-spacing="-2.5">Salesianos</text>

  <text x="62" y="370" font-family="Outfit, Arial, sans-serif" font-size="22" font-weight="500" fill="rgba(255,255,255,0.65)" letter-spacing="0.4">Festa Junina · 2026 · 9 brinquedos premium</text>
