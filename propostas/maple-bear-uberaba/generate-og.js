/**
 * Gera capa Open Graph 1200x630 premium para a proposta Maple Bear Uberaba.
 * Output: /propostas/maple-bear-uberaba/img/og-cover.jpg
 */
...
const featured = [
  ...
  'futebol-inflavel-tradicional-800.webp',
];
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
  ...
  <text x="60" y="298" font-family="Outfit, Arial, sans-serif" font-size="64" font-weight="900" fill="url(#redShimmer)" letter-spacing="-2.5">Maple Bear</text>
  <text x="60" y="364" font-family="Outfit, Arial, sans-serif" font-size="64" font-weight="900" fill="url(#redShimmer)" letter-spacing="-2.5">Uberaba</text>

  <text x="62" y="414" font-family="Outfit, Arial, sans-serif" font-size="22" font-weight="500" fill="rgba(255,255,255,0.65)" letter-spacing="0.4">Festa Junina · 2026 · 10 brinquedos premium</text>
