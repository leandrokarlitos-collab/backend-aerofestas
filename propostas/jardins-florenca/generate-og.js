 ...
 * Output: /propostas/jardins-florenca/img/og-cover.jpg
 */
...
const featured = [
  'combo-balao-magico-800.webp',
  'combo-girafa-800.webp',
  'futebol-inflavel-800.webp',
  'alpinismo-800.webp',
];
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
  ...
  <text x="60" y="235" font-family="Outfit, Arial, sans-serif" font-size="26" font-weight="600" fill="rgba(255,255,255,0.72)" letter-spacing="0.5">Proposta exclusiva</text>
  <text x="60" y="305" font-family="Outfit, Arial, sans-serif" font-size="64" font-weight="900" fill="url(#redShimmer)" letter-spacing="-2.5">Jardins Florença</text>

  <text x="62" y="352" font-family="Outfit, Arial, sans-serif" font-size="23" font-weight="500" fill="rgba(255,255,255,0.65)" letter-spacing="0.4">31 de julho de 2026</text>
